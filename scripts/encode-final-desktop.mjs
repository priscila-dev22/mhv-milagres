/**
 * Gera final.mp4 (desktop) a partir de uma fonte (padrão: public/media/videos/n d.mp4).
 * Perfil alinhado ao final anterior: 1920×1080, H.264, sem áudio, faststart.
 */
...
const output = path.join(videosDir, "final.mp4");
const tempOut = path.join(videosDir, "final.encode.mp4");
...
console.log("Codificando desktop a partir de:", source);
